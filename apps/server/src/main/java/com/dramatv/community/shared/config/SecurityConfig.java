    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/admin/auth/login")).permitAll()
                        ...
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/creators/*/works")).permitAll()
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/creators/*/videos")).permitAll()
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/creators/*/prompts")).permitAll()
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/creators/*/workflows")).permitAll()
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/creators/*/posts")).permitAll()
                        ...
                        .requestMatchers(antMatcher("/api/admin/**")).authenticated()
                        ...
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/api/comments/target-settings")).authenticated()
