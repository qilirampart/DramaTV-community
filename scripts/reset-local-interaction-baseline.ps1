...
$sqlPath = Join-Path $PSScriptRoot "reset-local-interaction-baseline.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Failed to reset local interaction baseline."
}

Write-Output "Local interaction baseline has been reset."
